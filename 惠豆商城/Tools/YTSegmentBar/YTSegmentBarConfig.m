...
+ (instancetype)shareInstance {
    ...
    dispatch_once(&onceToken, ^{
        ...
        segmentBarConfig.itemF = [UIFont systemFontOfSize:15];
        segmentBarConfig.itemNormalC = RGBHex(0x999999);
        segmentBarConfig.itemSelectC = RGBHex(0xE70422);
        segmentBarConfig.indicatorC = RGBHex(0xE70422);
